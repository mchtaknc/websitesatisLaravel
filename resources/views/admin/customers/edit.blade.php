...
<div class="container-fluid">
    <div class="card">
        ...
        <!-- /.card-header -->
        <form role="form" autocomplete="off" action="{{ route('admin.customers.update', $customer->id) }}" method="post"
            autocomplete="off">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('lastname') is-invalid @enderror"
                        id="lastname" name="lastname" value="{{ old('lastname', $customer->lastname) }}">
                    <span class="invalid-feedback" role="alert"><strong>{{$errors->first('lastname')}}</strong></span>
                </div>
                <div class="form-group">
                    <label for="name">Telefon Numarası</label>
                    <input type="tel" class="form-control form-control-sm @error('phonenumber') is-invalid @enderror"
                        id="phonenumber" name="phonenumber" value="{{ old('phonenumber', $customer->phonenumber) }}">
                    <span class="invalid-feedback"
                        role="alert"><strong>{{$errors->first('phonenumber')}}</strong></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('tax_id') is-invalid @enderror"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control form-control-sm @error('email') is-invalid @enderror"
                        id="email" name="email" value="{{ old('email', $customer->user->email) }}">
